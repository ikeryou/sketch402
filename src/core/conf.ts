...
export class Conf {
  ...
  // 本番フラグ
  // #############################################
  public IS_BUILD:boolean = import.meta.env.PROD;
  ...
  public FLG_SHOW_MATTERJS: boolean  = this.IS_BUILD ? false : false;
  ...
  public ITEM_NUM: number = 12;
  public SPEED: number = -0.02;
  public BASE_COLOR: Color = new Color(0x0000ff);
